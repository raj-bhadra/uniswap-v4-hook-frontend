...
({
        ...
        gradients: {
            radioSubtle:
                mode === "dark"
                    ...
                    : `radial-gradient(100% 90% at 50% 0, transparent 0, ${alpha(
                        blue[100],
                        0.3
                    )} 300%)`,
            linearSubtle:
                mode === "dark"
                    ? `linear-gradient(0deg, ${alpha(blue[900], 0.1)}, ${alpha(
                        blueDark[900],
                        0.5
                    )})`
                    : `linear-gradient(0deg, ${alpha(blue[50], 0.4)}, ${alpha(
                        grey[50],
                        0.1
                    )})`,
        },
    ...
    typography: {
        ...
        fontFamilyTagline: ["Open Sans Variable", ...systemFont].join(","),
        fontFamilySystem: systemFont.join(","),
        fontWeightSemiBold: 600,
        fontWeightExtraBold: 800,
        h1: {
            fontFamily: ["Open Sans Variable", ...systemFont].join(","),
                    ...
                    standardWarning: ({ theme }) => [
                        // same styles from the MarkdownElement callout
                        {
                            ...
                            "& * a": {
                                ...
                                "&:hover": {
                                    textDecorationColor: `${(theme.vars || theme).palette.warning[900]
                                        } !important`,
                                },
                            },
                        },
                        theme.applyDarkStyles({
                            ...
                            "& * a": {
                                color: `${(theme.vars || theme).palette.warning[100]
                                    } !important`,
                                textDecorationColor: `${alpha(
                                ...
                                "&:hover": {
                                    textDecorationColor: `${(theme.vars || theme).palette.warning[600]
                                        } !important`,
                                },
                            },
                        }),
                    ...
                    standardSuccess: ({ theme }) => [
                        // same styles from the MarkdownElement callout
                        {
                            ...
                            "& * a": {
                                ...
                                "&:hover": {
                                    textDecorationColor: `${(theme.vars || theme).palette.success[900]
                                        } !important`,
                                },
                            },
                        },
                        theme.applyDarkStyles({
                            ...
                            "& * a": {
                                ...
                                "&:hover": {
                                    textDecorationColor: `${(theme.vars || theme).palette.success[600]
                                        } !important`,
                                },
                            },
                        }),
                        ...
                        ...(ownerState.variant === "outlined" &&
                            ...
                            ...theme.applyDarkStyles({
                                ...
                                boxShadow: `${alpha(
                                    ...
                                    0.3
                                )} 0 1px 0 1px inset, ${(theme.vars || theme).palette.common.black
                                    } 0 -1px 0 1px inset, ${(theme.vars || theme).palette.common.black
                                    } 0 1px 2px 0`,
                                "&:hover": {
                        ...
                        style: ({ theme }) => [
                            ...
                            theme.applyDarkStyles({
                                ...
                                boxShadow: `${alpha(
                                    ...
                                    0.3
                                )} 0 1px 0 inset, ${(theme.vars || theme).palette.common.black
                                    } 0 -1px 0 inset, ${(theme.vars || theme).palette.common.black
                                    } 0 1px 2px 0`,
                                "&:hover": {
                                    borderColor: (theme.vars || theme).palette.primaryDark[600],
                                    background: alpha(theme.palette.primaryDark[700], 0.8),
                                    boxShadow: `${(theme.vars || theme).palette.common.black
                                        } 0 1px 2px 0`,
                                },
                                "&:active": {
                                    background: theme.palette.primaryDark[800],
                            ...
                            ...(ownerState.variant === "outlined" && {
                                ...
                                "&[href]": {
                                    ...
                                    boxShadow: `${alpha(
                                        theme.palette.primaryDark[700],
                                        0.4
                                    )} 0 2px 0 inset, ${(theme.vars || theme).palette.common.black
                                        } 0 -2px 0 inset, ${(theme.vars || theme).palette.common.black
                                        } 0 1px 2px 0`,
                                    "&:hover": {
